  ...
  login(){
    ...
    .subscribe((res)=>{
      ...
      if(res["pass"]!==0){
        ...
        this.usuario=new Usuario(res["datos"]["IDUsuario"],res["datos"]["Nombre"],res["datos"]["Apellidos"],res["datos"]["IDEmpresa"],res["datos"]["Puesto"],res["datos"]["IDConfig"],res["datos"]["Usuario"],res["datos"]["Correo"],res["datos"]["funciones"]);
